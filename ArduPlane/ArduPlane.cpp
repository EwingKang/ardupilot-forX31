...
const AP_Scheduler::Task Plane::scheduler_tasks[] = {
    ...
    SCHED_TASK(stabilize,             400,    100),     // EWING stabilize controller
    ...
    SCHED_TASK(navigate,               10,    150),     // EWING navigation controller
...
void Plane::ahrs_update()
{
    ...
    vel_available = ahrs.get_vel_NED_attitude(velQuat, vel_NED);
    if(vel_available) {
